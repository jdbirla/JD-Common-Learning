...
- [LinkedIn Learning](#linkedin-learning)
  ...
  - [Key Concepts to Understand Database Sharding](#key-concepts-to-understand-database-sharding)
  - [Logging, tracing and metrics are 3 pillars of system observability.](#logging-tracing-and-metrics-are-3-pillars-of-system-observability)
  - [How SSO/SAML works!](#how-ssosaml-works)
  - [Java Development - Cache Types](#java-development---cache-types)
  - [Some common #SQL interview questions along with their queries:](#some-common-sql-interview-questions-along-with-their-queries)
  ...
  - [The Evolving Landscape of API Protocols in 2023](#the-evolving-landscape-of-api-protocols-in-2023)
  - [Docker's growing adoption](#dockers-growing-adoption)
  - [Docker Architecture and Components](#docker-architecture-and-components)
  - [Log Parsing Cheatsheet](#log-parsing-cheatsheet)
  - [HTTPS encryption](#https-encryption)
  - [API Courses](#api-courses)
  - [Elevate Your Software Development with REST APIs](#elevate-your-software-development-with-rest-apis)
  - [Session, Cookie, JWT, Token, SSO, and OAuth 2.0 Explained in One Diagram](#session-cookie-jwt-token-sso-and-oauth-20-explained-in-one-diagram)
  - [🌐 Spring Security Architecture Overview 🛡️](#-spring-security-architecture-overview-)
  - [Single Sign-On (SSO) explained in simple terms.](#single-sign-on-sso-explained-in-simple-terms)
  - [Imperative Vs Functional Vs Object-oriented Programming](#imperative-vs-functional-vs-object-oriented-programming)
  - [Docker Key Commands Map 👇](#docker-key-commands-map-)
  - [How do we design effective and safe APIs?](#how-do-we-design-effective-and-safe-apis)
  - [Github Repos to Become Master in React](#github-repos-to-become-master-in-react)
  - [🐧 Understanding Linux File Permissions 🚀](#-understanding-linux-file-permissions-)
  - [Most used design patterns](#most-used-design-patterns)
  - [Understanding OAuth](#understanding-oauth)
  - [AWS Security Reference Architecture!](#aws-security-reference-architecture)
  - [Software Production Release Step by Step Guide](#software-production-release-step-by-step-guide)
  - [8 Essential Internet Protocols You Must Know](#8-essential-internet-protocols-you-must-know)
  - [Improving API performance](#improving-api-performance)
  - [Don't only apply for the job but also ensure to establish a network with the recruiter for the future.](#dont-only-apply-for-the-job-but-also-ensure-to-establish-a-network-with-the-recruiter-for-the-future)
  - [HTTP “verbs”](#http-verbs)
  - [Key Difference between SQL and NoSQL Databases!](#key-difference-between-sql-and-nosql-databases)
  - [How does HTTPS work?](#how-does-https-work)
  - [Which latency numbers you should know?](#which-latency-numbers-you-should-know)
  - [Notes](#notes)
  - [deployment strategies](#deployment-strategies)
  - [YAML and why?](#yaml-and-why)
  - [How To Release A Mobile App](#how-to-release-a-mobile-app)
  - [Top 12 Tips for API Security](#top-12-tips-for-api-security)
  - [Synchronous vs Asynchronous Explained.](#synchronous-vs-asynchronous-explained)
  - [Navigating the Database Landscape ❗️❗️](#navigating-the-database-landscape-)
  - [HTTP (Hypertext Transfer Protocol)](#http-hypertext-transfer-protocol)
  - [Linux File Permissions Explained to a 5 year old 😁](#linux-file-permissions-explained-to-a-5-year-old-)
  ...
  - [6 Database Types You Must Know](#6-database-types-you-must-know)
  - [9 types of API testing](#9-types-of-api-testing)
  - [API Gateway](#api-gateway)
  - [WORLD OF MICROSERVICES DESIGN PATTERN!!](#world-of-microservices-design-pattern)
  - [How Do C++, Java, and Python Function? We just made a video on this topic.](#how-do-c-java-and-python-function-we-just-made-a-video-on-this-topic)
  - [How do we transform a system to be Cloud Native?](#how-do-we-transform-a-system-to-be-cloud-native)
  - [Best ways to test system functionality. Next week's topic will be listed at the end.](#best-ways-to-test-system-functionality-next-weeks-topic-will-be-listed-at-the-end)
  - [Cloud Certifications - Role Based Roadmap 👇](#cloud-certifications---role-based-roadmap-)
  - [Explaining 5 unique ID generators in distributed systems.](#explaining-5-unique-id-generators-in-distributed-systems)
  - [Explaining JSON Web Token (JWT) to a 10 year old Kid.](#explaining-json-web-token-jwt-to-a-10-year-old-kid)
  - [IBM MQ -> RabbitMQ -> Kafka ->Pulsar](#ibm-mq---rabbitmq---kafka--pulsar)
  ...
  - [The 5 Deployment Patterns to Know in 2023](#the-5-deployment-patterns-to-know-in-2023)
  - [companies ship code to production](#companies-ship-code-to-production)
  - [What happens when you type a URL into a browser?](#what-happens-when-you-type-a-url-into-a-browser)
  - [sheet of various databases in cloud services](#sheet-of-various-databases-in-cloud-services)
  - [Very Powerful Words. Read it.](#very-powerful-words-read-it)
- [1. #Gratitude: Focus on what you're thankful for in your life.](#1-gratitude-focus-on-what-youre-thankful-for-in-your-life)
- [2. #Optimism: Embrace a positive outlook for the future.](#2-optimism-embrace-a-positive-outlook-for-the-future)
- [3. #SelfBelief: Believe in your abilities and potential.](#3-selfbelief-believe-in-your-abilities-and-potential)
- [4. #Positivity: Surround yourself with positive energy and people.](#4-positivity-surround-yourself-with-positive-energy-and-people)
- [5. #Empowerment: Take control of your life and goals.](#5-empowerment-take-control-of-your-life-and-goals)
- [6. #Resilience: Bounce back from challenges stronger than before.](#6-resilience-bounce-back-from-challenges-stronger-than-before)
- [7. #Kindness: Spread kindness and positivity to others.](#7-kindness-spread-kindness-and-positivity-to-others)
- [8. #Mindfulness: Stay present and appreciate each moment.](#8-mindfulness-stay-present-and-appreciate-each-moment)
- [9. #Growth: Embrace personal and professional growth opportunities.](#9-growth-embrace-personal-and-professional-growth-opportunities)
- [10. #Happiness: Pursue activities and relationships that bring joy.](#10-happiness-pursue-activities-and-relationships-that-bring-joy)
  - [caching systems](#caching-systems)
  - [JWT Explained](#jwt-explained)
  - [Top 5 Kafka use cases.](#top-5-kafka-use-cases)
  - [🔐 Understanding OAuth 2.0 Flows: Keeping Your Data Secure! 🔒](#-understanding-oauth-20-flows-keeping-your-data-secure-)
  - [Top 5 Software Architectural Patterns You Must Know](#top-5-software-architectural-patterns-you-must-know)
  - [🚀 SQL Roadmap for Success 🚀](#-sql-roadmap-for-success-)
  - [Mastering Variable Naming: Best Practices for Clarity and Readability](#mastering-variable-naming-best-practices-for-clarity-and-readability)
  ...
  - [Learn to Implement CI/CD Seamlessly in Agile:](#learn-to-implement-cicd-seamlessly-in-agile)
  - [120 Mind-Blowing AI Tools for Video, Productivity, Marketing, Chatbot, Design & Writing.](#120-mind-blowing-ai-tools-for-video-productivity-marketing-chatbot-design--writing)
  - [Cloud-native vs. Cloud computing](#cloud-native-vs-cloud-computing)
  - 
## 𝗠𝗮𝘀𝘁𝗲𝗿𝗶𝗻𝗴 𝗗𝗲𝘃𝗢𝗽𝘀: 𝗔 𝗩𝗶𝘀𝘂𝗮𝗹 𝗚𝘂𝗶𝗱𝗲
